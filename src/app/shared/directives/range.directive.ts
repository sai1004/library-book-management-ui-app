...
@Directive({
    selector: "[RangeAttr][ngModel]",
    providers: [{ provide: NG_VALIDATORS, useExisting: forwardRef(() => RangeValidatorDirective), multi: true }],
})
export class RangeValidatorDirective implements Validator {
    private validator: ValidatorFn;

    constructor(@Attribute("RangeAttr") range: string) {
